    ...
    <nav className="fixed w-full bg-black text-white z-50">
        ...
        <div className="flex justify-between items-center h-20 ">
          ...
          <div className="hidden md:block">
            <div className="flex gap-10 items-center">
              ...
              <a href="#packages" className="text-white hover:text-gray-300">
                Packages
              </a>
      ...
      >
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <a href="#home" className="block px-3 py-2 text-white">
            Home
          </a>
          ...
          <a href="#packages" className="block px-3 py-2 text-white">
            Packages
          </a>
          <a href="#contactus" className="block px-3 py-2 text-white">
            Contact Us
          </a>
